   ...
   <?php  
                ...
                $sql_query = "SELECT * FROM `teacherinfo` WHERE `name`='{$name}' and `pigeonhole`='{$pigeonhole}' ";

                if($science_class != 'empty'){
                    $sql_query = "SELECT * FROM `teacherinfo` WHERE `name`='{$name}' and `science_class`='{$science_class}' and `pigeonhole`='{$pigeonhole}' ";
                    if($date1 && $date2){
                        $sql_query = "SELECT * FROM `teacherinfo` WHERE `name`='{$name}' and `science_class`='{$science_class}' and (`science_time` between '{$date1}' and '{$date2}') and `pigeonhole`='{$pigeonhole}' ";
                    }
                }
                else if($teach_class != 'empty'){
                    $sql_query = "SELECT * FROM `teacherinfo` WHERE `name`='{$name}' and `teach_class`='{$teach_class}' and `pigeonhole`='{$pigeonhole}' ";
                    if($date3 && $date4){
                        $sql_query = "SELECT * FROM `teacherinfo` WHERE `name`='{$name}' and `teach_class`='{$teach_class}' and (`teach_time` between '{$date3}' and '{$date4}') and `pigeonhole`='{$pigeonhole}' ";
                    }
                }
                else if($other_class != 'empty'){
                    $sql_query = "SELECT * FROM `teacherinfo` WHERE `name`='{$name}' and `other_class`='{$other_class}' and `pigeonhole`='{$pigeonhole}' ";
                    if($date5 && $date6){
                        $sql_query = "SELECT * FROM `teacherinfo` WHERE `name`='{$name}' and `other_class`='{$other_class}' and (`other_time` between '{$date5}' and '{$date6}') and `pigeonhole`='{$pigeonhole}' ";
                    }
                }
                else if($famous_class != 'empty'){
                    $sql_query = "SELECT * FROM `teacherinfo` WHERE `name`='{$name}' and `famous_class`='{$famous_class}' and `pigeonhole`='{$pigeonhole}' ";
                    if($date7 && $date8){
                        $sql_query = "SELECT * FROM `teacherinfo` WHERE `name`='{$name}' and `famous_class`='{$famous_class}' and (`famous_time` between '{$date7}' and '{$date8}') and `pigeonhole`='{$pigeonhole}' ";
                    }
                }
