...
if (isset($_POST['flag'])) {
    try {
        ...
        if ($_POST['flag'] == "insert") {
            $sql = "INSERT INTO `graduate`(`name`, `year`, `award_name`, `award_time`, `rank`, `licenceauth`, `awark_class`, `time`) VALUES ('{$_POST['name']}','{$_POST['year']}','{$_POST['award_name']}','{$_POST['award_time']}','{$_POST['rank']}','{$_POST['licenceauth']}','{$_POST['awark_class']}','{$_POST['time']}')";
        } else {    //更新数据
