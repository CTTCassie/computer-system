...
<div data-options="region:'center',title:'计算机学院信息化管理系统-研究生获奖信息'" style="padding:5px;height:90%;background:#eee;">
...
<script type="text/javascript" charset="utf-8">
    ...
    function getdata(arr) {
        ...
        datagrid = $("#dd").datagrid({
            url: "/studentinfo/postgraduate/updatepostgraduate.php",  //请求的数据源
